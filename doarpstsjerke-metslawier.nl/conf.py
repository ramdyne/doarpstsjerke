...
# BASE_URL = "http://doarpstsjerke-metslawier.nl/"
BLOG_EMAIL = "Stichting.Doarpstsjerke.Metslawier@outlook.com"
BLOG_DESCRIPTION = "Stichting Doarpstsjerke Metslawier"  # (translatable)
...
# (translatable)
CONTENT_FOOTER = 'Inhoud &copy; {date}  {author}'
